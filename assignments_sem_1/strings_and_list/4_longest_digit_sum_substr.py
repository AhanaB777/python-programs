...
Problem: Given a string consisting of positive-integer numbers separated by spaces (for example: "12 3 45 9 10 2 100"), treat each number as an integer, compute the digit-sum of each number, then find
